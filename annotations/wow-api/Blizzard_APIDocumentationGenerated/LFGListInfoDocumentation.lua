...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_LFGList.ConfirmCensoredActiveEntry)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_LFGList.DoesCensoredTextMatch)
---@param name string
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_LFGList.IsCensoredActiveEntryUnresolved)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_LFGList.RevealCensoredActiveEntry)
function C_LFGList.RevealCensoredActiveEntry() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_LFGList.RevealCensoredSearchResult)
---@param searchResultID number
