...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.AddAuraSound)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.CancelAuraByInstanceID)
---@param unit UnitTokenRestrictedForAddOns
---@param auraInstanceID number
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.GetGroupBuffVisualAlerts)
---@return GroupBuffVisualAlertInfo[] visualAlerts
function C_UnitAuras.GetGroupBuffVisualAlerts() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.GetHiddenGroupBuffs)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.RemoveAuraSound)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.SetGroupBuffVisualAlerts)
---@param visualAlerts GroupBuffVisualAlertInfo[]
function C_UnitAuras.SetGroupBuffVisualAlerts(visualAlerts) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_UnitAuras.SetHiddenGroupBuffs)
