...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.GetDelveEntranceTitleString)
---@return string? title
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.GetFlavorNodeForCompanion)
---@param companionID? number
---@return number nodeID
function C_DelvesUI.GetFlavorNodeForCompanion(companionID) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.GetFlavorNodeNameForCompanion)
---@param companionID? number
---@return string name
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.GetWorldTierDifficultyForActivePlayer)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.HasActiveLFGLair)
---@return boolean result
function C_DelvesUI.HasActiveLFGLair() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.HasActiveLair)
---@return boolean result
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DelvesUI.IsInLair)
---@return boolean result
