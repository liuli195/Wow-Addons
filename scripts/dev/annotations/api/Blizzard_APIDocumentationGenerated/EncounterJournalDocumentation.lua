...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_EncounterJournal.GetBaseDifficultyID)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_EncounterJournal.InstanceHasDifficultyID)
---@param difficultyID number
