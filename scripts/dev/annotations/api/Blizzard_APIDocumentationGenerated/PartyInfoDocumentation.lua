...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.ConfirmReadyCheck)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.DemoteAssistant)
---@param name string
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.DoReadyCheck)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.IsGUIDInGroup)
---@param guid WOWGUID
---@param category? number
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.PromoteToAssistant)
---@param name string
---@param exactNameMatch? boolean
function C_PartyInfo.PromoteToAssistant(name, exactNameMatch) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.PromoteToLeader)
---@param name string
---@param exactNameMatch? boolean
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.SetEveryoneIsAssistant)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PartyInfo.UninviteUnit)
---@param name string
---@param reason? string
---@param exactNameMatch? boolean
