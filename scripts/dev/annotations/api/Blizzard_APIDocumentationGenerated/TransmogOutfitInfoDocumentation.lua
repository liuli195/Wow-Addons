...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TransmogOutfitInfo.CanPlayerTransmogSlot)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TransmogOutfitInfo.IsTransmogEnabled)
---@return boolean enabled
