...
---[Documentation](https://warcraft.wiki.gg/wiki/API_GetEventCPUUsage)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_GetFunctionCPUUsage)
---@return number call_time
---@return number call_count
function GetFunctionCPUUsage() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_GetScriptCPUUsage)
---@return number result
