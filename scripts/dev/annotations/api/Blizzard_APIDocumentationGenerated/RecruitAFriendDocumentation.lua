...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_RecruitAFriend.IsSystemEnabled)
---@return boolean isSystemEnabled
function C_RecruitAFriend.IsSystemEnabled() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_RecruitAFriend.IsSystemSupported)
