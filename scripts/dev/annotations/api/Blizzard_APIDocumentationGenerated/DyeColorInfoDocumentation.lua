...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DyeColor.GetDyeColorsForItem)
---@param itemLinkOrID ItemInfo
---@return number[] dyeColorIDs
function C_DyeColor.GetDyeColorsForItem(itemLinkOrID) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_DyeColor.GetDyeColorsForItemLocation)
