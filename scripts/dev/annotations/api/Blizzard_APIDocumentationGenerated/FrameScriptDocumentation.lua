...
---[Documentation](https://warcraft.wiki.gg/wiki/API_GetForbiddenObjectTable)
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_securecopy)
---@param value? LuaValueReference
---@param options? SecureCopyOptions
---@return LuaValueReference copy
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_settablesecurity)
...
---@field maxTraversalDepth number? Default = 100
---@field wrapUntrustedFunctions boolean? Default = true
---@field permitScriptObjects boolean? Default = false
