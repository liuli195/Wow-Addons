...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PaperDollInfo.CancelTemporaryEnchantment)
---@param slot any
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PaperDollInfo.GetInventorySlotInfo)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PaperDollInfo.GetInventorySlotInfoForInvSlot)
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_PaperDollInfo.GetTemporaryEnchantmentInfo)
---@param slot any
