...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingCustomizeMode.ApplyPetToSelectedDecor)
---@param petID? WOWGUID
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingCustomizeMode.GetSelectedDecorPetInfo)
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingCustomizeMode.RoomConnectionSupportsDoorType)
