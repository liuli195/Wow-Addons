...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Spell.GetLastCategoryCooldownSource)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Spell.GetMawPowerRarityInfoBySpellID)
---@param spellID SpellIdentifier
...
---Returns nil if spell is not found
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Spell.GetSpellDescriptionForItemLocation)
---@param spellIdentifier SpellIdentifier
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Spell.TargetSpellChecksItemCondition)
