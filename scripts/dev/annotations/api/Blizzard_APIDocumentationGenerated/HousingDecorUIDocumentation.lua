...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.AnyDecorPlacedInRoom)
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.GetAllMaxPlacementBudgets)
---@return number[]? interiorMaxBudgets
---@return number[]? exteriorMaxBudgets
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.GetAllSpentPlacementBudgets)
---@return number[]? interiorSpentBudgets
---@return number[]? exteriorSpentBudgets
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.GetDecorAssignedPetName)
---@param decorGUID WOWGUID
---@return string? name
function C_HousingDecor.GetDecorAssignedPetName(decorGUID) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.GetDecorCanAttachPet)
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.GetMaxPetPlacementBudget)
...
---
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_HousingDecor.GetSpentPetPlacementBudget)
