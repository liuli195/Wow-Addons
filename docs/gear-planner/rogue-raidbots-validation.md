...
```powershell
.venv/Scripts/python.exe tests/gear-planner/research/check-deathknight-raidbots.py --fixtures projects/gear-planner/fixtures/raidbots-rogue --engine .tools/gear-planner-research/simc-1210.01.c1935b9-win64/simc.exe --output .local/gear-planner-rogue-validation/current-engine-check.json
node tests/gear-planner/check-deathknight.cjs fixtures/raidbots-rogue
```
